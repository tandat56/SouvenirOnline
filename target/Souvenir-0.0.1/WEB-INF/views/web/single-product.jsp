    ...
    <div class="row">
      <div class="col-12">
        <div class="breadcrumb-title text-center my-20">
          <h2 class="title text-dark text-capitalize">Chăm sóc tóc</h2>
        </div>
      </div>
      <div class="col-12">
        <ol class="breadcrumb bg-transparent m-0 p-0 align-items-center justify-content-center">
          ...
          <li class="breadcrumb-item">
            <a href="<c:url value='/page-shopgrid4'/>">Cơ thể</a>
          </li>
          ...
          <div class="block-reassurance">
            <ul>
              <li>
                ...
                Chính sách bảo mật (chỉnh sửa với mô-đun trấn an khách hàng)
              </li>
              <li>
               <img src="<c:url value='/template/web/assets/img/icon/10.png'/>" alt="img">
                Chính sách bảo mật (chỉnh sửa với mô-đun trấn an khách hàng)
              ...
              <li>
               <img src="<c:url value='/template/web/assets/img/icon/10.png'/>" alt="img">
                Chính sách giao hàng (chỉnh sửa với mô-đun trấn an khách hàng)
              </li>
            </ul>
          </div>
        </div>
...
<section class="theme1 bg-white pb-70">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <div class="section-title text-center mb-30">
          <h2 class="title text-dark text-capitalize">12 Sản phẩm khác cùng danh mục</h2>
          <p class="text mt-10">các sản phẩm khác cùng danh mục:</p>
        </div>
      </div>
      <div class="col-12">
        <div class="product-slider-init slick-nav">

                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                        ...
                        <div class="row grid-view theme1">
                            ...
                            <c:forEach var="item11" items="${model.listResult}">

                                <div class="col-sm-6 col-md-4 mb-30">
                                    <div class="card product-card">
                                        <div class="card-body p-0">
                                            <form method="get" action="<c:url value="/AddCart/${item11.id}"/> " >
                                            ...
                                            <div class="product-desc">
                                                <h3 class="title"><a href="shop-grid-4-column.html"> ${item11.title}</a></h3>
                                                ...
                                                <h6 class="product-price"><fmt:formatNumber type="number" groupingUsed="true" value="${item11.price}" /> ₫</h6>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- product-list End -->

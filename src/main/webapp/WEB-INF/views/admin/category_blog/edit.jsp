...
<c:url var="editBlogURL" value="/quan-tri/the-loai-bai-viet/chinh-sua"/>
<c:url var="blogAPI" value="/api/category-blog"/>
<html>
<head>
				...
				<div class="col-xs-12">
					...
					<form:form class="form-horizontal" role="form" id="formSubmit" modelAttribute="model">
						<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Tên thể loại bài viết</label>
								<div class="col-sm-9">
						...
						<div class="form-group">
							<label for="level" class="col-sm-3 control-label no-padding-right">Level thể loại:</label>
							<div class="col-sm-9">
								<form:input path="level" rows="5" cols="5" cssClass="form-control" id="level" />
							</div>
						</div>
